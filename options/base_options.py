...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default='0,1',
            help='e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument(
            '--checkpoints_dir',
            type=str,
            default='./checkpoints',
        ...
        parser.add_argument(
            ...
            help='scaling and cropping of images.',
            choices=(
                "resize_and_crop",
                "crop",
                "fixed",
        ...
        parser.add_argument('--dataset_mode', type=str, default='angio')
        parser.add_argument(
            '--serial_batches',
            action='store_true',
        ...
        parser.add_argument(
            '--no_clip',
            action='store_true',
            help='if specified, do not clip the images for data preprocessing')
        parser.add_argument(
            '--clip_rgin',
            type=dict,
            default={
                'min': 950,
                'max': 1200},
            help='clip images to this range')
        parser.add_argument(
            '--clip_rgout',
            type=dict,
            default={
        ...
        parser.add_argument(
            '--no_minmax',
            action='store_true',
            help='if specified, do not normalize the images for range')
        parser.add_argument('--mm_range', type=tuple,
